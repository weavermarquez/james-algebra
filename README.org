...
OH MY GOSH, it took a while for me to recognize what I wasn't just looking at some random logo, but once it hit, holy crap!! it looks so good!! I have wanted this for SO LONG. Thank you!! Let's destroy mathphobia!!

network dialect
- I feel like the root forest should be rooted 
- We need to disambiguate the atoms.
  - I think we need a little fancy font for the atoms. Can we represent the greek letters with the actual unicode in title style with a nice font? Google fonts is fine for now, though I can go have a look.
- regarding Shared structure:
  - I'm trying to think of how we're going to help readability. When you gave me a more complex richer form, it was hard to tell which lines went where. But I think that is probably a renderer concern. Maybe the edges can have some transparency, or maybe some sort of shape manipulation similar to how knot diagrams depict over/under.
  - Do you think we're going to have to do force network diagrams / spring dynamics when various nodes are sharing structure? Or maybe that's a concern for later?
  
logic
- Why no factory function for angles? 
- I feel like we should unify and shorten the factory functions for wrapRound and wrapSquare?

I would like to have a temporary button on screen that steps through the enfolding sequence that is in the test.
